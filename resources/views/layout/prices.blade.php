<section style="background:#fff;" class="font-sans container m-auto max-w-xl flex flex-col flex-wrap sm:flex-row justify-center mt-8 ">
            ...
            <div style="border-right:1px solid #f06d46;" class="w-full sm:w-1/3 lg:w-1/3 text-center py-8 bg-white h-85 ">
                ...
                <button onclick="window.location='{{route('invoice',['package'=>'1'])}}'" style="background:#fc005e;" class="butn font-smooth btn-4 bg-transparent hover:bg-black text-black-dark font-termina-m uppercase hover:text-white py-2 px-4 border border-black hover:border-transparent">
                    Buy Now
                </button>
            ...
            <div style="border-right:1px solid #f06d46; border-bottom:1px solid #f06d46;" class="w-full sm:w-1/3 lg:w-1/3 text-center bg-white  h-85">
                ...
                <button onclick="window.location='{{route('invoice',['package'=>'2'])}}'" style="background:#0087fc;" class="butn btn-4 bg-transparent hover:bg-black font-smooth text-black-dark font-termina-m uppercase hover:text-white py-2 px-4 border border-black hover:border-transparent">
                    Buy Now
                </button>
            ...
            <div class="w-full sm:w-1/3 lg:w-1/3 text-center py-8 bg-white  h-85">
...
<section style="background:#f78b2754; " class="antialiased font-sans w-full bg-white text-left text-black py-8 container m-auto p-8">
  <div class="container mx-auto max-w-xl py-8 font-normal ">
    <h3 style="width: 40%" class="text-4xl font-termina-m">Get the goodies delivered straight to your inbox </h3>
    <p class="font-termina-l text-grey-darkest text-xl mt-2 mb-2">Subscribe to the newsletter</p>  <img class="img-news" src="img/newsletter.webp">
    <div class="max-w-sm mt-4 sm:flex">
      <input type="email" class="block font-termina-l w-full focus:outline-0 bg-white py-3 px-6 mb-2 sm:mb-0" name="email" placeholder="Enter your email" required="">
      <button style="height: 50px" class="uppercase text-sm text-white focus:outline-0 w-full sm:w-auto bg-black hover:bg-grey-darkest focus:bg-grey-light tracking-wide px-6 font-termina-md">Subscribe</button>
    </div>
  </div>
</section>