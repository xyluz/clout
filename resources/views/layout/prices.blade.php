<section style="background:#fff;" class="font-sans container m-auto max-w-xl flex flex-col flex-wrap sm:flex-row justify-center mt-8 ">
            ...
            <div style="border-right:1px solid #f06d46;" class="w-full sm:w-1/3 lg:w-1/3 text-center py-8 bg-white h-85 ">
                ...
                <a href="{{route('invoice',['package'=>'1'])}}" style="background:#fc005e; text-decoration:none;" class="butn font-smooth btn-4 bg-transparent hover:bg-black text-black-dark font-termina-m uppercase hover:text-white py-2 px-4 border border-black hover:border-transparent">
                    Buy Now
                </a>
