    ...
    <section class=" font-sans mt-8">
            <div class="container max-w-xl m-auto flex flex-wrap items-center text-center">
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 flex flex-col mb-8 px-3">
                    ...
                    <p style="opacity: .9" class="font-seg text-m text-white font-smooth mt-2 serv-title"> <a class="no-underline text-white tag-tag" href="{{route('special-packages-single',Str::slug('Music Production'))}}"> Starting from N30,000  </a></p>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 flex flex-col mb-8 px-3">
                    <div class="h-64" style=" background: url('https://images.unsplash.com/photo-1490971588422-52f6262a237a?ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80'); box-shadow: rgba(20, 20, 20,.1) 625px 10px 108px 6px inset; background-size: cover; background-position: center; ">
                        <p style="opacity: .9" class="font-seg text-m text-white font-smooth mt-2 serv-title"> <a class="no-underline text-white tag-tag" href="{{route('special-packages-single',Str::slug('Studio Sessions'))}}"> Starting from ---  </a></p>
                        <p class="font-termina-md text-25xl text-white font-smooth mt-2 serv-title"> Studio Sessions</p>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 flex flex-col mb-8 px-3">
                    <div class="h-64" style=" background: url('https://images.unsplash.com/photo-1504509546545-e000b4a62425?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80'); box-shadow: rgba(20, 20, 20,.5) 625px 10px 108px 6px inset; background-size: cover; background-position: center; ">
                        <p style="opacity: .9" class="font-seg text-m text-white font-smooth mt-2 serv-title"> <a class="no-underline text-white tag-tag" href="{{route('special-packages-single',Str::slug('Studio Rental'))}}"> Starting from ---  </a></p>
                        <p class="font-termina-md text-25xl text-white font-smooth mt-2 serv-title">Studio Rental</p>
                        <p class="font-seg text-m text-white font-smooth mt-2 serv-title "> <a class="no-underline text-white" href="{{route('special-packages-single',Str::slug('Studio Rental'))}}"> Music Recording · Music Engineering  </a></p>
