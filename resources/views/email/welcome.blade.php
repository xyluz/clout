                ...
                <tr>
                  <td class="o_bg-white o_px o_py-md o_br-t o_sans o_text" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;border-radius: 4px 4px 0px 0px;padding-left: 16px;padding-right: 16px;padding-top: 24px;padding-bottom: 24px;">
					<p style="margin-top: 0px;margin-bottom: 0px;">
						...
						<a class="o_text-primary" href="{{route('home')}}" style="text-decoration: none;outline: none;color: #126de5;">
            ...
            <table class="o_block" width="100%" cellspacing="0" cellpadding="0" border="0" role="presentation" style="max-width: 632px;margin: 0 auto;">
              <tbody>
                <tr>
				  ...
				  <h2 class="o_heading o_text-dark o_mb-xxs" style="font-family: Helvetica, Arial, sans-serif;font-weight: bold;margin-top: 0px;margin-bottom: 4px;color: #242b3d;font-size: 30px;line-height: 39px;">Hello {{$user->name}}! </h2>
                    <p class="o_mb-md" style="margin-top: 0px;margin-bottom: 24px;">You have finished creating your Clout Account</p>
                    <table align="center" cellspacing="0" cellpadding="0" border="0" role="presentation">
                      <tbody>
                        <tr>
						  ...
						  <a class="o_text-white" href="{{route('campaign')}}" style="text-decoration: none;outline: none;color: #ffffff;display: block;padding: 12px 24px;mso-text-raise: 3px;">Start Your First Campaign</a>
                          </td>
                        </tr>
                      </tbody>
                    </table>
              ...
              <tbody>
                <tr>
                  <td class="o_bg-white o_px-md o_py o_sans o_text o_text-secondary" align="center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 16px;line-height: 24px;background-color: #ffffff;color: #424651;padding-left: 24px;padding-right: 24px;padding-top: 16px;padding-bottom: 16px;">
                    <p style="margin-top: 0px;margin-bottom: 0px;">At Clout we pride ourselves in helping you get to your desired audience and we have various plans and packages carefully tailored to achieve your promotional goals. Select any of our plans or packages to begin your journey  .
					</p>
                  </td>
                </tr>
              </tbody>
                  ...
                  <td class="o_re o_px o_pb-lg" align="center" style="font-size: 0;vertical-align: top;padding-left: 16px;padding-right: 16px;padding-bottom: 32px;">
                    ...
                    <div class="o_col o_col-4" style="display: inline-block;vertical-align: top;width: 100%;max-width: 400px;">
                      ...
                      <div class="o_px-xs o_sans o_text-xs o_text-light o_left o_xs-center" style="font-family: Helvetica, Arial, sans-serif;margin-top: 0px;margin-bottom: 0px;font-size: 14px;line-height: 21px;color: #82899a;text-align: left;padding-left: 8px;padding-right: 8px;">
                        <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">©2019 Clout. All rights reserved.</p>
                        <p class="o_mb-xs" style="margin-top: 0px;margin-bottom: 8px;">267A Etim Inyang Cres, Victoria Island, Lagos</p>
                        <p style="margin-top: 0px;margin-bottom: 0px;">
                          <a class="o_text-light o_underline" href="/" style="text-decoration: underline;outline: none;color: #82899a;">Terms & Conditions
                          ...
                          <a class="o_text-light o_underline" href="/" style="text-decoration: underline;outline: none;color: #82899a;">Legal</a> <span class="o_hide-xs">&nbsp; • &nbsp;</span><br class="o_hide-lg" style="display: none;font-size: 0;max-height: 0;width: 0;line-height: 0;overflow: hidden;mso-hide: all;visibility: hidden;">
						<a class="o_text-light o_underline" href="{{route('faq')}}" style="text-decoration: underline;outline: none;color: #82899a;">FAQ</a>
                        </p>
                      </div>
                    </div>
